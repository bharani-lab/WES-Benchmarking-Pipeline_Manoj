...
#Variant_calling
gatk --java-options "-Xmx10g" HaplotypeCaller -R "$Re1" -I output/"$r1"/"$r1"_RG.bam -O output/"$r1"/soap_GATK_"$r1".vcf.gz
...
vcvcftools --vcf output/"$r1"/soap_GATK_"$r1".vcf --keep-only-indels  --recode --recode-INFO-all --out output/"$r1"/soap_GATK_Indels_"$r1".vcf
